...
Thank you for #test# your interest in Atlas! Atlas is a wiki-like, git-managed authoring platform for creating books. If you haven't already, you may want to check out the http://atlas.labs.oreilly.com/getting_started[getting started video] ((("video", "introduction to Atlas")))for a quick introduction to Atlas.
