...
. When you're ready, build your book. Atlas interfaces with O’Reilly’s publishing toolchain and generates EPUB, Mobi, and PDF files for you on the fly. The ebook files look just like those for sale on O'Reilly.com 
...
* Provide feedback. Atlas is current in alpha testing, and we need to hear from you to take it to the next level. If you're not able or willing to provide feedback, Atlas might not be right for you at this time.
