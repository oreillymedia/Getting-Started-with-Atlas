...
Atlas uses http://d3js.org/[D3] to support interactive presentation of data in the HTML version of the book. To present your data, you need only add a reference to a CSV file, like so:
