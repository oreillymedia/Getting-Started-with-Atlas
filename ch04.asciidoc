...
[[SECTION_ID]]
=== Top-Level Section
This one designates AsciiDoc level 2 (DocBook +<sect1>+). The markup looks like this:
...
This one designates AsciiDoc level 3 (DocBook +<sect2>+). The markup looks like this:

-----------
==== Second-Level Section (Delimited Style)
-----------

Also note that you can have the delimiter on both sides of the title, like this:
...
This one designates AsciiDoc level 4 (DocBook +<sect3>+). The markup looks like this:
