...
*+&#x2a;&#x2b;Constant width bold&#x2b;&#x2a;+*:: Used to show commands or other text that should be typed literally by the user.
pass:[<replaceable>Constant width italic</replaceable>]:: Indicates text that should be replaced with user-supplied values or by values determined by context. This inline element markup uses a docbook passthrough, like this: +pass:[<replaceable>Constant width italic</replaceable>]+
