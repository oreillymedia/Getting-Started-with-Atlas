...
The Atlas book-building toolchain now supports syntax highlighting via http://pygments.org/[Pygments]. All you need to do is add +[source]+ above each code block that you want to be syntax-highlighted, and specify the language of the code. For example, the following code:
